...
import Canape from './icons/Canape.vue'
  ...
  <div class="program">
    <Animate animationClass="animate__fadeInUp" class="program__item">
      ...
      <div class="program__content">
        ...
        <p class="program__text">
          <span class="accent-text-bold">Фотопрогулка. Театральный сквер</span> Если вы хотите
          сфотографироваться с нами, подходите к
          <a
          ...
          >
          в 15.00. Сделаем несколько классных снимков на память,<br />
    ...
    <Animate animationClass="animate__fadeInUp" class="program__item">
      ...
      <div>
        ...
        <p class="program__text">
          <span class="accent-text-bold">Сбор гостей. Ресторан «Кухтерин»</span>
          Если вы не любитель фотографироваться и вам <br />
          достаточно фото из ресторана, приходите сразу в «Кухтерин». <br />
          Для вас будет организован фуршет, где можно перекусить перед началом мероприятия,
    ...
    <Animate animationClass="animate__fadeInUp" class="program__item">
      ...
      <div>
        ...
        <p class="program__text">
          ...
          Банкет начнется в 17.00, но просим вас прийти раньше, чтобы не <br />
    ...
    <Animate animationClass="animate__fadeInUp" class="program__item">
      ...
      <div>
        <h2 class="program__time">21.30</h2>
        <p class="program__text">
          <span class="accent-text-bold">Тортик</span><br />
          Даже тем, кто не ест после шести, рекомендуем попробовать вкуснейший тортик. А чтобы он не
    ...
    <Animate animationClass="animate__fadeInUp" class="program__item">
      ...
      <div>
        <h2 class="program__time">23.00</h2>
        <p class="program__text">
          <span class="accent-text-bold">Окончание банкета</span><br />
          Даже такой прекрасный день когда-то заканчивается… Мы очень надеемся, что у вас останутся
